...
import { Mail, Lock, Eye, EyeOff, User, AlertCircle, FileText, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen gradient-mesh flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center">
        <div className="absolute inset-0 bg-gradient-to-br from-[#7c3aed] via-[#06b6d4] to-[#10b981] opacity-90" />
        ...
        <div className="relative z-10 text-center px-12 text-white">
          ...
          >
            ...
            <p className="text-lg text-white/80 max-w-sm mx-auto">
              Create an account to upload templates, save favorites, and connect with other creators.
            </p>
          </motion.div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-8 py-12">
        ...
        >
          ...
          <p className="text-[var(--text-secondary)] mb-8">
            ...
            <Link href="/auth/login" className="text-[var(--color-primary)] font-medium hover:underline">Log in</Link>
          </p>
